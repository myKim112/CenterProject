...
private static MyReviewDAO instance = new MyReviewDAO();
		...
		try {
			...
			pstmt = conn.prepareStatement(
					...
					if (rs.next()) {
						...
						do{ 
							MyReviewDTO article= new MyReviewDTO();
	...
	public void insertArticle(MyReviewDTO article) throws Exception {
	...
	public MyReviewDTO getArticle(int num) throws Exception {
		MyReviewDTO article=null;
		try {
			conn = getConnection();
			pstmt = conn.prepareStatement(
	...
	public MyReviewDTO updateGetArticle(int num) throws Exception {
		MyReviewDTO article=null;
		try {
			conn = getConnection();
			pstmt = conn.prepareStatement(
	...
	public int updateArticle(MyReviewDTO article) throws Exception {
		String dbpasswd="";
		String sql="";
		int x=-1;
		try {
	...
	public int updateArticlePlus(MyReviewDTO article) throws Exception {
		String dbpasswd="";
		String sql = "";
		int x = -1;
		try {
