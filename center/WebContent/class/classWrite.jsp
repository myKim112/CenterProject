...
<body bgcolor="${bodyback_c}">
	<center><b>강좌소개</b></center><br>
		<form method="post" name="writeform" action="classWritePro.kiki"onsubmit="return writeSave()">
			...
			<table width="700" border="0" cellspacing="0" cellpadding="0"
				...
				<tr>
					<td align="center" rowspan="9"><input type="file"
						name="save" /></td>
				...
				<td colspan="4" align="right">
					<input type="button" value="즉시결제"
						onclick="javascript:window.location='classState.kiki'" />
					<input type="button" value="강좌바구니"
						onclick="javascript:window.location='classbasket.kiki'" />
						</td>
				</tr>
			</table>
			<br/><br/>
			...
			<tr>
				...
				<tr>
					...
					<td width="330">강좌시작일 3일전 마감</td></tr>
				...
				<tr>
					...
					<textarea rows="50" cols="100" name="classSummary" style="margin:0px; width:1134px; height:300px; resize:none;">
					</textarea>
					</td>
				...
				<tr>
					...
					<td width="330" colspan="3" >
					<textarea  rows="50" cols="100"name="classPlan"style="margin:0px; width:1134px; height:300px; resize:none;"></textarea>
					</td>
					<tr>
					<td colspan="4" align="center" >		
					<hr align="center" style="border: solid 0.3px lightgray;">
				...
				<tr>
					<td colspan="4" align="right"><input type="submit"
						...
						OnClick="window.location='classList.kiki'"></td>
				</tr>
			</table>
