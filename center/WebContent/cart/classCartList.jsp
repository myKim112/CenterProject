...
<body>
<form action="cartPro.kiki" method="post">



<table border="0" width="1400" cellpadding="0" cellspacing="0" align="center"style="table-layout:fixed">
<tr><td><font style="Arial" size="10" align="left" >cart</font></td></tr>

<tr><td colspan="37" align="center"><b>(장바구니수:${count})</b></td></tr>
<tr><td><hr align="center" style="border: solid 1px black;" WIDTH="1400"></td></tr>
<tr>
...
<table border="0" width="1400" cellpadding="0" cellspacing="0" align="center"style="table-layout:fixed">
<tr>
<td colspan="2" align="center"><input type="checkbox" value="${dto.tnum }"></td>
<td colspan="3" align="center" >${dto.center }</td>
<td colspan="4" align="center" >${dto.classCode}</td>
<td colspan="15" align="center">
<a href="classContent.kiki?num=${dto.cnum}&pageNum=${currentPage}">${dto.className }</a></td>
...
<input type="button" value="삭제" onclick="javascript:window.location='cartDel.kiki?num=${dto.num}&pageNum=${pageNum }'" /> 
</td></tr>
</table>
</body>
</html>
